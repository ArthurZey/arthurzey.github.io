...
date: "2020-04-17"
last_modified_at: "2025-10-28T14:15:54+00:00"
---
...
* the connection between moral accountability/agency and determinism
  ...
  * What's important is that what I did was a product of my choice, not whether that choice was necessitated by antecedent factors.
...
* Think about all the various gradations that exist along biological continua, especially as regards brain development and neuronal activity. (See [_A Brief History of Intelligence_](https://www.goodreads.com/book/show/62050269-a-brief-history-of-intelligence){:target="&lowbar;blank"}.) All brain activities, capacities, and powers have evolved from the very earliest and rudimentary processing of sense input into more and more complex processes. When typical non-determinist volitionists claim some special status of volition that is not just the behavior of the underlying brain matter, I'm reminded of how the religious intelligent design folks express incredulity that the eye could have evolved naturally: Both commit the error of not understanding the various gradations along the way. And with volition, different manifestations and levels of volition are observable across species alive today, between different human beings, and even across time in the same individual. It's a completely material, biological phenomenon--complex, yes--and that evolved following a similar high-level pattern as other complex phenomena like eyes.
...
* what sense of "determinism" I think Ayn Rand was actually objecting to (and [what I think is misunderstood by many Objectivists](http://aynrandlexicon.com/lexicon/determinism.html){:target="&lowbar;blank"})
  ...
  * The only difference between my view and the view of most Objectivists is that I think that whatever choice I made is the one I had to make and most Objectivists think that whatever choice I made I could have made differently. But we both agree that I made a choice and that it was the dominant or proximate cause of the action that I took.
  * The problem with the approach that Objectivists are taking is that they're basically ceding the premise that volition depends on the power to have done otherwise, which will ultimatley be a losing battle as science (especially neuroscience) continues to show, with more and more precision, that everything is necessitated by antecedent causes. The only way to save volition--and more crucially, moral accountability--from the onslaught of sloppy determinists is to clarify that, regardless of its underlying mechanics, volition is real and when something is a product of it, that opens it up to moral accountability.
...
* maybe some polemics around what prominent cultural figures have to say about it? (meh)
  ...
  * Sam Harris's [We Really Don't Have Free Will? (Episode #360)](https://www.samharris.org/episode/SE37D659617){:target="&lowbar;blank"}, interview with Robert Sapolsky (via [Robert Nasir](https://www.facebook.com/500496844/posts/10159935245081845/){:target="&lowbar;blank"})
  ...
  * [_Determined_](https://www.goodreads.com/book/show/83817782-determined){:target="&lowbar;blank"} by Robert Sapolsky and [Kailuo Wang's review on Goodreads (with my comments, too)](https://www.goodreads.com/review/show/5914350927){:target="&lowbar;blank"}
  * Marsha Enright's [Life is not a Machine or a Ghost: The Naturalistic Origin of Life's Organization and Goal-Directedness, Consciousness, Free Will, and Meaning](https://marsha-familaro-enright.com/wp-content/uploads/2023/04/Enright-Marsha-Life-is-not-a-machine-or-a-ghost-JARS_23_1_2_05.pdf){:target="&lowbar;blank"}
  * Craig Biddle's [Free Will: Who Has It](https://www.theobjectivestandard.com/p/free-will-who-has-it){:target="&lowbar;blank"}
  * Robert Nasir's [Facebook post](https://www.facebook.com/RobertNasir/posts/pfbid0wZHoWfj48CzceuKZEZHmCrgAaSiTc2xcWgBrCexf45AL27AZ7aRR1Er1CBCeLYfzl){:target="&lowbar;blank"}
  * Dan Norton's [Life as the standard; AI, consciousness & life; how v. whether; causation; focus, good & evil; etc.](https://www.youtube.com/watch?v=vAmr5vYeTmc){:target="&lowbar;blank"} YouTube video from 2025-06-18
